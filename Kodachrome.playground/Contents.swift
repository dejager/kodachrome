...
* mobile device.
* Progam your own shader function in `lifeUhFindsAWay` in AllTheCrapILearnedInHighSchool.metal.
...
do {
  let path = Bundle.main.path(forResource: "AllTheCrapILearnedInHighSchool", ofType: "metal")
...
renderer.functionName = "giveUsThoseNiceBrightColors"
